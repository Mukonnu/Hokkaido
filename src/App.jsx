...
const DAYS = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "08:30", title: "🌊 オシンコシンの滝", type: "spot", tags: ["知床八景"], desc: "知床八景。国道沿い駐車場すぐ。「双美の滝」の二筋の流れ。階段で中段展望台へ行くと水しぶきを間近に。滞 জনপ্র15〜20分。" },
      {
        time: "09:30",
        title: "🌿 知床五湖",
        type: "spot",
  ...
  },
  {
    ...
    events: [
      ...
      { 
        ...
        title: "レンタカー返却", 
        type: "move", 
        desc: "新千歳空港 着。レンタカーを返却し、送迎バスで空港へ。" 
      },
      { 
        time: "16:30", 
        title: "📦 荷物発送ミッション", 
        type: "spot", 
        important: true,
        desc: "ANAなので重量制限はないが、「福岡での1週間を身軽に過ごすため」に、泥だらけのトレッキング靴やACGのアウターなど、北海道の重装備一式をクロネコヤマト等で平塚の自宅へ発送する。" 
      },
      { 
        time: "17:00", 
        title: "♨ 新千歳空港温泉", 
      ...
      { 
        ...
        title: "✈ 新千歳→福岡", 
        type: "move", 
        desc: "ANA便でテイクオフ。体はポカポカ、腹はパンパン、荷物は最小限の最強の状態で九州へ帰還。ありがとう北海道。" 
      },
    ],
    gourmet: [
