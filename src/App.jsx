...
const DAYS = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "13:00", title: "紋別 カニ爪", type: "spot", tags: ["休憩"], desc: "巨大カニ爪オブジェ（高さ12m）で記念撮影。宗谷→北見の中間地点。運転交代ポイント。出塚水産の手揚げかまぼこをおやつに。" },
      {
        ...
        tags: ["焼肉"],
        important: true,
        desc: "四条ホルモン。創業40年超。冷凍なしサガリ+豚ホルモンを「生ダレ」で。ハッカハイボール必飲。食べログ焼肉百名店。\n\n⚠⚠⚠ 月曜定休！4/27は月曜。事前に必ず電話確認。休みなら味覚園 北見本店へ。",
        price: "¥3,000〜4,000",
        hours: "17:00〜23:00（月曜定休）",
        tel: "0157-23-1927",
      },
    ],
    warnings: [
    ...
    gourmet: [
      { name: "味覚園 北見本店", note: "四条ホルモン月曜定休の場合の代替。地元民率高い焼肉老舗。", tags: ["焼肉", "代替"] },
  ...
  },
  {
    ...
    stay: "札幌ホテル",
    stayIcon: "🏨",
    highlight: "旅のクライマックス。390 DUKEとGB350で釧路湿原を走り、聖地・細岡駅にバイクで乗り付ける。",
    mapQuery: "釧路+阿寒町+釧路湿原+帯広+札幌",
    events: [
      {
        time: "08:30",
        title: "🏍 Moto-Technix 釧路店",
        type: "spot",
        tags: ["バイク"],
        important: true,
        desc: "阿寒町。9:00オープン、30分前着がベスト。\n\n【俺】KTM 390 DUKE—373cc/44PS/149kg。NITRONサス。アグレッシブなストリートファイター。\n【相方】Honda GB350—348cc/20PS/180kg。NITRONサス。ネオクラシックの王道。\n\n真逆のキャラで並走する最高の絵面。ヘルメット・ウェア貸出あり(有料)。返却後シャワー可。",
        tel: "0154-64-7618",
        addr: "釧路市阿寒町中央3-1-31",
      },
      {
        ...
        tags: ["バイク", "聖地"],
        important: true,
        desc: "約80km/3h：\n\n店舗→道道222号→①釧路湿原展望台→道道1060号(湿原沿い最高ルート)→②コッタロ湿原(タンチョウ遭遇率高)→③細岡駅(🎯聖地。DUKEで無人駅に乗り付ける瞬間)→国道391号→店舗\n\n⚠ 信号ゼロ。スピード注意。エゾシカ最警戒。給油は出発前満タン（ルート上GSなし）。気温5〜10℃、グローブ・ネックウォーマー必須。",
      },
      { time: "13:00", title: "バイク返却", type: "move", desc: "シャワー借りてさっぱり。レンタカーで帯広へ。阿寒→帯広 約100km/1.5h。" },
      {
        time: "15:00",
        title: "🐷 ぱんちょう",
        type: "food",
        tags: ["豚丼"],
        important: true,
        desc: "1933年創業。豚丼発祥。炭火ロース+甘辛タレ。梅(6枚)がおすすめ。名前の順が逆なのは初代女将「梅さん」にちなむ。\n\n⚠ 月曜＋第1第3火曜定休。4/29(水祝)はOK。現金のみ。",
        hours: "11:00〜19:00",
        tel: "0155-22-1974",
      },
      { time: "16:00", title: "🍰 六花亭 本店", type: "food", tags: ["スイーツ"], desc: "本店限定「サクサクパイ」(¥200)は賞味期限3時間。パイ生地にカスタードの至高の一品。2F喫茶室コーヒー無料。マルセイバターサンドもここで。", hours: "10:00〜18:00" },
      { time: "16:30", title: "帯広→札幌", type: "move", desc: "高速約3h。高速代¥5,000。バイクの疲れが出るので運転交代必須。トマムSAで休憩を。" },
      { time: "20:00", title: "🍜 最後の夜", type: "food", tags: ["ラーメン"], desc: "すみれ（味噌ラーメンの金字塔。濃厚味噌+ラード）かSuage+（スープカレー。具材ゴロゴロ）。どちらかは食べて帰りたい。" },
    ],
    warnings: ["帯広→札幌は高速3h。バイク疲れで運転交代必須"],
    gourmet: [
      { name: "クランベリー 本店", note: "帯広。さつまいも丸ごとくりぬいたスイートポテト。六花亭の近く。", tags: ["帯広"] },
      { name: "サッポロビール園", note: "札幌着20時頃なら。ジンギスカン+生ビール。", tags: ["札幌"] },
    ],
  },
  {
    id: 7,
    ...
    mapQuery: "札幌+新千歳空港",
    events: [
      { time: "09:00", title: "🦀 札幌場外市場", type: "food", tags: ["お土産"], desc: "60店舗以上。カニ・鮭・いくら全国配送可。活き毛ガニがおすすめ。値段交渉もできる。", hours: "6:00〜15:00" },
      { time: "14:00", title: "♨ 新千歳空港温泉", type: "onsen", desc: "国内線4F。露天風呂・サウナ・仮眠室。タオル館内着付き手ぶらOK。レストランもあり。\n⚠ 再入場不可。飲食物は事前購入。", price: "¥1,800" },
      { time: "18:25", title: "✈ 新千歳→福岡", type: "move", desc: "21:15福岡着。7日間1,540km。ジンギスカン・タコしゃぶ・焼肉・炉端・豚丼・ラーメン。礼文島12.4km。DUKEとGB350で湿原。ありがとう北海道。" },
    ],
    gourmet: [
      { name: "きのとや（空港内）", note: "焼きたてチーズタルト。搭乗前の最後のスイーツ。", tags: ["空港"] },
      { name: "ロイズ チョコレートワールド", note: "空港内。工場見学無料。限定チョコ多数。", tags: ["空港"] },
    ],
  },
];
...
const CHECKLIST = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Moto-Technix 予約済み", sub: "4/29 9:00-17:00 DUKE+GB350。" },
    ],
  },
  {
    cat: "🚗 ドライブ＆一般",
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
          <div style={{ flex: 1 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
              ...
              {ev.optional && (
                <span style={{ fontSize: 9, background: "#ede6d8", color: "#8a7f72", padding: "2px 7px", borderRadius: 8 }}>
                  余裕あれば
                </span>
              )}
            </div>
          ...
          <div style={{ textAlign: "right", flexShrink: 0 }}>
            ...
            <div style={{ fontSize: 14, color: c, transition: "transform .3s", transform: open ? "rotate(180deg)" : "rotate(0)", marginTop: 2 }}>▾</div>
          </div>
        </div>
        <div
          style={{
              ...
              {day.gourmet.map((g, i) => (
                <div key={i} style={{ background: "linear-gradient(135deg,#fff9f5,#fff)", border: "1px solid rgba(212,85,58,.1)", borderRadius: 10, padding: "8px 12px", marginTop: 4 }}>
                  ...
                  {g.tags && (
                    <div style={{ display: "flex", gap: 4, marginTop: 3, flexWrap: "wrap" }}>
                      {g.tags.map((t) => (
                        <span key={t} style={{ fontSize: 9, color: "#d4553a", background: "rgba(212,85,58,.06)", padding: "1px 5px", borderRadius: 5 }}>
                          {t}
                        </span>
                      ))}
                    </div>
  ...
  return (
    <div style={{ fontFamily: "'Zen Maru Gothic',sans-serif", background: "#faf8f5", minHeight: "100vh", maxWidth: 480, margin: "0 auto" }}>
      ...
      <div style={{ textAlign: "center", padding: "32px 16px 28px", color: "#8a7f72", fontSize: 12 }}>
        ...
        <div>札幌→稚内→礼文→北見→知床→釧路→帯広→札幌</div>
      </div>
    </div>
  );
}
